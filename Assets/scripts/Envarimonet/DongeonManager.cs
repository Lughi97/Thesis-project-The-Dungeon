...
/// Then the enemy, items and wepons objects are placed in the ennviroment randomly
/// </summary>
public enum DongeonType{Cave,Room,CrossRoom,VerticalCrossRoom,BossRoom};

public class DongeonManager : MonoBehaviour
{
    public  DongeonType _dungeonType;
    ...
    void Start()
    {
        ...
        switch (_dungeonType)
        {
            case DongeonType.Cave:
                RandomWalkerCaverns();
                break;
            case DongeonType.Room:
                RoomWalker();
                break;
            case DongeonType.BossRoom:
                BossRoomWalker();
                break;
            case DongeonType.CrossRoom:
                CrossRoomWalker();
                break;
            case DongeonType.VerticalCrossRoom:
                VerticalCorssWalker();
                break;
        }
    ...
    Vector3 HallwayLenght(Vector3 myPos)
    {
        ...
        int walkLenght = Random.Range(9, 21);// the lenght of the walk
